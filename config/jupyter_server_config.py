...
c.LabApp.default_url = ('/lab' if get_djlab_config(
                            'djlab.jupyter_server.display_filepath') == 'NULL'
                        else '/lab/tree{}'.format(
                            get_djlab_config(
                                'djlab.jupyter_server.display_filepath').replace(
